...
glaser-tei stands for Digital (Scholarly) Editions Base Application. Its purpose is to bootstrap the development of (web) applications which support the process of
...
glaser-tei is a successor of the generic-de-web-app project described by the blog post series [How to build a digital edition web app](https://howto.acdh.oeaw.ac.at/blog/books/how-to-build-a-digital-edition-web-app/). While these blog posts were focused on describing general principles and basic implementations of a digital edition web app, glaser-tei should help you getting things done.
generic-de-web-app as well as glaser-tei are designed as (almost) self-containing eXist-db packages. Therefore you can
...
`git clone https://github.com/KONDE-AT/glaser-tei.git <folder-name>`

2. Run a search and replace through the whole codebase, replacing `glaser-tei` with e.g. the name of your application’s root directory. Since `glaser-tei` is used in several namespaces, make sure the replacement string does not contain any tricky characters.
