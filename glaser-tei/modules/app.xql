...
declare variable $app:done := $config:app-root||'/data/done';
...
(:~
 ...
 for $hit in collection(concat($config:app-root, '/data/done/'))//*[.//tei:ab[@type="syntactic-markup" and ft:query(.,$searchterm)]]
