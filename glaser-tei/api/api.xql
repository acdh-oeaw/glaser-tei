...
declare 
    %rest:GET
    %rest:path("/glaser-tei/api/about")
...
function api:api-about($format as xs:string*, $pageNumber as xs:integer*, $pageSize as xs:integer*) {
    let $endpoints := 
        <result>
            <ep>
                <url>/glaser-tei/api/collections</url>
            ...
            <ep>
                <url>{"/glaser-tei/api/collections/{$collection}"}</url>
...
declare 
    %rest:GET
    %rest:path("/glaser-tei/api/collections")
    %rest:query-param("page[number]", "{$pageNumber}", 1)
    %rest:query-param("page[size]", "{$pageSize}", 20)
    %rest:query-param("format", "{$format}", 'json')
...
declare 
    %rest:GET
    %rest:path("/glaser-tei/api/collections/{$collection}")
    %rest:query-param("page[number]", "{$pageNumber}", 1)
    %rest:query-param("page[size]", "{$pageSize}", 20)
    %rest:query-param("format", "{$format}", 'json')
...
declare
    %rest:GET
    %rest:path("/glaser-tei/api/entities")
    %rest:query-param("page[number]", "{$pageNumber}", 1)
    %rest:query-param("page[size]", "{$pageSize}", 20)
    %rest:query-param("format", "{$format}", 'json')
...
declare 
    %rest:GET
    %rest:path("/glaser-tei/api/collections/{$collection}/{$id}")
...
declare
    %rest:GET
    %rest:path("/glaser-tei/api/entities/{$id}")
...
declare
    %rest:GET
    %rest:path("/glaser-tei/api/entity-types")
    %rest:query-param("page[number]", "{$pageNumber}", 1)
    %rest:query-param("page[size]", "{$pageSize}", 20)
    %rest:query-param("format", "{$format}", 'json')
...
declare 
    %rest:GET
    %rest:path("/glaser-tei/api/entity-types/{$id}")
